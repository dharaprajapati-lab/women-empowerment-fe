...
const impactStats = [
  {
    ...
    suffix: "+",
    label: "Lives Impacted",
    sub: "Across rural and urban communities",
    icon: Users,
  },
  {
    value: 220,
    ...
    sub: "Schools, health centers, cooperatives",
    icon: Building2,
  },
  {
    value: 7,
...
export default function HomePage() {
  return (
    <div className="bg-[#fbf4f1] text-[#170d08]">
      {/* Hero */}
      <section className="border-b border-[#ead4cc]/50">
        <div className="mx-auto grid max-w-[1220px] items-center gap-14 px-5 py-10 mt-20 sm:px-8 md:py-20 lg:grid-cols-[0.95fr_1.05fr] lg:py-24">
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-[#9f2f1f]">
              CommDev Foundation
            </p>

            <h1 className="mt-5 max-w-[590px] text-[45px] font-bold leading-[0.98] tracking-[-0.04em] text-[#120a06] sm:text-[58px] lg:text-[68px]">
              Driving Change
              <br />
              From Within
            </h1>
      ...
      {/* Impact */}
      <section className="bg-[#f0e8e4] px-5 py-24 sm:px-8 md:py-36">
        <div className="mx-auto max-w-[1220px]">
          <div className="mb-14 text-center">
            <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-[#9f2f1f]">
              Our Reach
            </p>
            <h2 className="mt-3 text-[30px] font-medium tracking-[-0.025em] text-[#140b07]">
              The Impact So Far
            </h2>
            <p className="mt-3 mx-auto max-w-[440px] text-[14px] leading-relaxed text-[#675953]">
              Measurable progress towards a more equitable future.
            </p>
          </div>

          <div className="grid gap-px overflow-hidden rounded-[8px] bg-[#d9ccc6] sm:grid-cols-3">
            {impactStats.map(({ value, suffix, label, sub, icon: Icon }) => (
              <div
                key={label}
                className="bg-[#f0e8e4] px-8 py-14 text-center sm:py-16"
              >
                <Icon className="mx-auto h-5 w-5 text-[#9f2f1f]/60" strokeWidth={1.5} />

                <div className="relative mx-auto mt-6 flex h-[110px] w-[220px] items-center justify-center sm:h-[120px] sm:w-[240px]">
                  <div className="absolute inset-0 rounded-full bg-[#9f2f1f]/[0.06]" />
                  <div className="absolute inset-3 rounded-full bg-[#9f2f1f]/[0.05]" />
                  <div className="font-heading relative text-[48px] font-medium leading-none tracking-tight text-[#9f2f1f] sm:text-[56px]">
                    <CountUp value={value} suffix={suffix} />
                  </div>
                </div>

                <p className="mt-5 text-[16px] font-semibold text-[#1a0f09]">
                  {label}
                </p>

                <p className="mt-1.5 text-[13px] text-[#7a6d65]">
                  {sub}
                </p>
              </div>
            ))}
      ...
      {/* Partnerships Teaser */}
      {/* <section className="bg-white px-5 py-20 sm:px-8 border-t border-[#e2c8bf]/20">
        <div className="mx-auto max-w-[1220px]">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-10">
            <div>
              ...
              <h2 className="mt-3 text-[28px] font-medium tracking-[-0.025em] text-[#140b07]">
                Partnerships & Collaborations
              </h2>
              <p className="mt-2 text-[14px] text-[#675953]">
                CSR & Institutional Partners driving our mission forward.
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-[4px] border border-[#e2c8bf] bg-[#fbf4f1] px-5 py-2.5 text-[13px] font-semibold text-[#3e3029] transition-colors hover:border-[#9f2f1f] hover:text-[#9f2f1f] shrink-0"
            >
              View All Partners
              <ArrowRight className="h-3.5 w-3.5" />
            </Link>
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {partners.slice(0, 8).map((partner) => (
              <div
                key={partner}
                className="rounded-full border border-[#e2c8bf] bg-[#fbf4f1] px-5 py-2.5 text-[13px] font-medium text-[#3e3029] transition-colors hover:border-[#9f2f1f] hover:text-[#9f2f1f]"
              >
                {partner}
              </div>
            ))}
            <Link
              href="/about/partnerships"
              className="rounded-full border border-dashed border-[#9f2f1f]/40 bg-transparent px-5 py-2.5 text-[13px] font-semibold text-[#9f2f1f] transition-colors hover:bg-[#9f2f1f]/5"
            >
