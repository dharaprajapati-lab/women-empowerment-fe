...
const navItems = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Livelihoods", href: "#" },
      { label: "Public Health", href: "#" },
      { label: "Policy and Governance", href: "#" },
      { label: "Child Protection", href: "#" },
  ...
  },
  {
    ...
    children: [
      ...
      // {
      //   label: "Health Systems Accountability",
      //   href: "/insights/health-systems-accountability",
      // },
      { label: "Blogs", href: "#" },
      { label: "Opinions", href: "#" },
        ...
        <div className="flex items-center justify-between h-24">
            ...
            {navItems.map((item) => (
              ...
              >
                <Link
                  href={item.href}
                  className={cn(
                    "flex items-center gap-1.5 px-4 py-2.5 text-[15px] font-medium rounded-md transition-colors duration-200",
                ...
                {item.children && (
                  <div
                    className={cn(
                      "absolute top-full left-0 min-w-[240px] bg-white rounded-xl shadow-xl border border-border/60 py-1.5 transition-all duration-200 origin-top",
                  ...
                  >
                    {item.children.map((child) => (
                      <Link
                        ...
                        href={child.href}
                        className={cn(
                          "block px-5 py-3 text-sm transition-colors duration-150 hover:bg-[#fdf8f3]",
                          pathname === child.href
          ...
          <div className="flex items-center gap-2">
            <Link href="/get-involved/donate">
              <Button
                size="default"
                className="hidden lg:flex bg-[#8b2635] hover:bg-[#7a2130] text-white shadow-sm px-5 py-2.5 text-sm"
              >
            ...
            <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
              <SheetTrigger
                className="lg:hidden p-2.5 rounded-md text-foreground hover:bg-muted transition-colors"
              ...
              <SheetContent side="right" className="w-80 overflow-y-auto">
                ...
                <div className="mt-8 pt-6 border-t border-border">
                  ...
                  >
                    <Button className="w-full bg-[#8b2635] hover:bg-[#7a2130] text-white py-5 text-sm">
